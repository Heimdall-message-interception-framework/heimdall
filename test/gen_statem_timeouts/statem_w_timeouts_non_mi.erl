...
set_event_to() ->
  set_event_to(500).
set_event_to(Time) ->
  gen_statem:cast(?MODULE, {set_event_to, Time}).
set_state_to() ->
  set_state_to(500).
set_state_to(Time) ->
  gen_statem:cast(?MODULE, {set_state_to, Time}).
set_general_to() ->
  set_general_to(500).
set_general_to(Time) ->
  gen_statem:cast(?MODULE, {set_general_to, Time}).
switch_state() ->
  gen_statem:cast(?MODULE, {switch_state}).
keep_state() ->
  gen_statem:cast(?MODULE, {keep_state}).
cancel_state_to() ->
  gen_statem:cast(?MODULE, {cancel_state_to}).
cancel_general_to() ->
  gen_statem:cast(?MODULE, {cancel_general_to}).
