...
%%%-------------------------------------------------------------------
-module(timeout_non_mi_tests_SUITE).
-author("fms").
...
%%  start observer and state machine
  ...
  {ok, _StatemPID} = statem_w_timeouts_non_mi:start(),
%%  set logs
...
test_event_to(_Config) ->
  statem_w_timeouts_non_mi:set_event_to(),
  timer:sleep(1000),
...
test_event_to_keep_state(_Config) ->
  statem_w_timeouts_non_mi:set_event_to(),
  statem_w_timeouts_non_mi:keep_state(),
  timer:sleep(1000),
  ListEvents = observer_timeouts:get_list_events(),
...
test_event_to_switch_state(_Config) ->
  statem_w_timeouts_non_mi:set_event_to(),
  statem_w_timeouts_non_mi:switch_state(),
  timer:sleep(1000),
  ListEvents = observer_timeouts:get_list_events(),
...
test_state_to(_Config) ->
  statem_w_timeouts_non_mi:set_state_to(),
  timer:sleep(1000),
  ListEvents = observer_timeouts:get_list_events(),
...
test_state_to_cancel_to(_Config) ->
  statem_w_timeouts_non_mi:set_state_to(),
  statem_w_timeouts_non_mi:cancel_state_to(),
  timer:sleep(1000),
  ListEvents = observer_timeouts:get_list_events(),
...
test_state_to_set_inf(_Config) ->
  statem_w_timeouts_non_mi:set_state_to(),
  statem_w_timeouts_non_mi:set_state_to(infinity),
  timer:sleep(1000),
  ListEvents = observer_timeouts:get_list_events(),
...
test_state_to_reset_time(_Config) ->
  statem_w_timeouts_non_mi:set_state_to(),
  statem_w_timeouts_non_mi:set_state_to(200),
  timer:sleep(1000),
  ListEvents = observer_timeouts:get_list_events(),
...
test_general_to(_Config) ->
  statem_w_timeouts_non_mi:set_general_to(),
  timer:sleep(1000),
  ListEvents = observer_timeouts:get_list_events(),
...
test_general_to_cancel_to(_Config) ->
  statem_w_timeouts_non_mi:set_general_to(),
  statem_w_timeouts_non_mi:cancel_general_to(),
  timer:sleep(1000),
  ListEvents = observer_timeouts:get_list_events(),
...
test_general_to_set_inf(_Config) ->
  statem_w_timeouts_non_mi:set_general_to(),
  statem_w_timeouts_non_mi:set_general_to(infinity),
  timer:sleep(1000),
  ListEvents = observer_timeouts:get_list_events(),
...
test_general_to_reset_time(_Config) ->
  statem_w_timeouts_non_mi:set_general_to(),
  statem_w_timeouts_non_mi:set_general_to(200),
  timer:sleep(1000),
  ListEvents = observer_timeouts:get_list_events(),
